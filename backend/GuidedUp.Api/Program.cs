...
// Read the agenda-generator skill once at startup
...
// POST /agenda — generate a session agenda
app.MapPost("/agenda", async (AgendaRequest request) =>
{
    // --- Validation (profile-validator rules) ---
    ...
    // Check for duplicate questions (fuzzy: >70% similarity)
